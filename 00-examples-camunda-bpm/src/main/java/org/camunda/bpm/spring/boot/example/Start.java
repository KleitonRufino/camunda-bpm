...
public class Start {
  ...
  void teste() {
	  ProcessEngine pe = ProcessEngineConfiguration.createStandaloneInMemProcessEngineConfiguration().buildProcessEngine();
		 ...
		 createDeployment().name("teste").addInputStream("teste.bpmn", 
				 getClass().getClassLoader().getResourceAsStream("teste.bpmn")).deploy();
		 pe.getRuntimeService().startProcessInstanceByKey("teste");
  }
}
